...
ModalWindow {
    ...
    DialogBox {
        ...
        TabView {
            ...
            // [OneMaker MV] - Duplicate the above options but for Aries001_AnimationScreenEffects context.
            Tab {
                title: qsTr("Aries001")
                TabColumn {
                    Label {
                        text: qsTr("This requires the Aries001_AnimationScreenEffects plugin\nto become available.")
