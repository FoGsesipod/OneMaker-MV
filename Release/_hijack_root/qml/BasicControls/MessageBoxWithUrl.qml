    ...
    Rectangle {
        ...
        Column {
            ...
            Rectangle {
                ...
                implicitWidth: Math.max(540, contents2.implicitWidth + 60)
                implicitHeight: Math.max(88, contents2.implicitHeight + 20)
                Row {
                    id: contents2
                    ...
                    Text {
                        ...
                        width: Math.min(540, sizeHint.paintedWidth)
                    }
                    Text {
                        id: sizeHint
                        text: root.message
            ...
            Rectangle {
                width: 600
                color: PaletteSingleton.normalBack1
                implicitWidth: Math.max(540, contents3.implicitWidth + 60)
                implicitHeight: Math.max(88, contents3.implicitHeight + 20)
                Row {
                    id: contents3
                    anchors.centerIn: parent
                    spacing: 12
                    MouseArea {
                        width: messageText2.paintedWidth
                        height: messageText2.paintedHeight
                        hoverEnabled: true
                        cursorShape: Qt.PointingHandCursor;
                        onClicked: urlOpener.open(root.url + root.userId);
                    Text {
                        id: messageText2
                        text: '<a href="#" style="color: ' + PaletteSingleton.hyperLinkText + ';">' + root.url + root.userId + '</a>'
