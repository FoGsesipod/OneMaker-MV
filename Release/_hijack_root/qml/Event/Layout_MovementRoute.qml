    ...
    GroupBoxColumn {
        ...
        ControlsRow {
            ...
            Button {
                ...
                text: qsTr("Show Map")
                hint: qsTr("")
                width: (200 + OneMakerMVSettings.getSetting("windowSizes", "defaultWidthIncrease")) / 3
        ...
        ControlsRow {
            MapEditorBaseView {
                id: mapView
                editMode: 1
                width: 665 + (OneMakerMVSettings.getSetting("windowSizes", "defaultWidthIncrease") * 2)
                height: 224 + OneMakerMVSettings.getSetting("windowSizes", "defaultHeightIncrease")
                tileScale: 1/2
